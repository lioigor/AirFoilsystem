...
<!-- content -->
		<article id="content">
			...
			<section class="col2">
				<h2 class="pad_bot1">Download template file with measurement results</h2>
				<p class="pad_bot1 color1 pad_top1">At the stage of development! In the future it will be possible to download some file for your use our service. The template file will be presented in the near future.</p>
