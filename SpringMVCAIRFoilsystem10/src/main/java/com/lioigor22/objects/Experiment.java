...
// if (Double.doubleToLongBits(diameterOfProbes) !=
// Double.doubleToLongBits(other.diameterOfProbes))
// return false;
// if (flowVelocity != other.flowVelocity)
// return false;
// if (id != other.id)
// return false;
// if (Double.doubleToLongBits(kinematicViscosity) !=
// Double.doubleToLongBits(other.kinematicViscosity))
// return false;
// if (name == null) {
// if (other.name != null)
// return false;
...
// return false;
// if (Double.doubleToLongBits(powerEngine) !=
// Double.doubleToLongBits(other.powerEngine))
// return false;
// if (Double.doubleToLongBits(pressure) !=
// Double.doubleToLongBits(other.pressure))
// return false;
// if (Double.doubleToLongBits(temperature) !=
// Double.doubleToLongBits(other.temperature))
// return false;
// if (Double.doubleToLongBits(tubeSize) !=
// Double.doubleToLongBits(other.tubeSize))
// return false;
// return true;
// }
//
...
// return "Experiment [id=" + id + ", name=" + name + ", temperature=" +
// temperature + ", pressure=" + pressure + ", flowVelocity=" + flowVelocity +
// ", kinematicViscosity=" + kinematicViscosity + ", diameterOfProbes=" +
// diameterOfProbes
