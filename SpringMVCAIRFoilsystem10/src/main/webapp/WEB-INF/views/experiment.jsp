				...
				<div class="wrapper">
					...
					<nav>
						<ul id="menu">
							...
							<li id="menu_active"><a
								href="${pageContext.request.contextPath}/experiment"><span><span>Experiment
											preview</span></span></a></li>
							<li class="nav3"><a
								href="${pageContext.request.contextPath}/support"><span><span>Support</span></span></a></li>
							<li class="nav4"><a
								href="${pageContext.request.contextPath}/downloads"><span><span>Downloads</span></span></a></li>
							<li class="nav5"><a
								href="${pageContext.request.contextPath}/contacts"><span><span>Contacts</span></span></a></li>
						</ul>
					</nav>
				</div>
			</header>
						...
						<ul class="list2">
							...
							<form:form action="${addAction}" commandName="experiment">
								...
								<table>
									...
									<tr>
										<td><form:label path="pressure">
												<spring:message text="Pressure" />
											</form:label></td>
										<td><form:input path="pressure" /></td>
									</tr>
									<tr>
										<td><form:label path="flowVelocity">
												<spring:message text="Flow Velocity" />
											</form:label></td>
										<td><form:input path="flowVelocity" /></td>
									</tr>
									<tr>
										<td><form:label path="kinematicViscosity">
												<spring:message text="Kinematic Viscosity" />
											</form:label></td>
										<td><form:input path="kinematicViscosity" /></td>
									</tr>
									<tr>
										<td><form:label path="diameterOfProbes">
												<spring:message text="Diameter Of Probes" />
											</form:label></td>
										<td><form:input path="diameterOfProbes" /></td>
									</tr>
									<tr>
										<td><form:label path="tubeSize">
												<spring:message text="TubeSize" />
											</form:label></td>
										<td><form:input path="tubeSize" /></td>
									</tr>
									<tr>
										<td><form:label path="powerEngine">
												<spring:message text="Power Engine" />
											</form:label></td>
										<td><form:input path="powerEngine" /></td>
									</tr>
									<tr>
										<td colspan="2"><c:if test="${!empty experiment.name}">
												<input type="submit"
													value="<spring:message text="Edit Experiment"/>" />
											</c:if> <c:if test="${empty experiment.name}">
												<input type="submit"
