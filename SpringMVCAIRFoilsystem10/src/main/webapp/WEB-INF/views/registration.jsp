									...
									<spring:bind path="username">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											<form:input type="text" path="username" class="form-control"
												placeholder="Username" autofocus="true"></form:input><br>
											<font color="red"><form:errors path="username"></form:errors><br></font>
										</div>
									</spring:bind>
									...
									<spring:bind path="password">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											<form:input type="password" path="password"
												class="form-control" placeholder="Password"></form:input><br>
											<font color="red"><form:errors path="password"></form:errors><br></font>
										</div>
									</spring:bind>
									...
									<spring:bind path="confirmPassword">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											<form:input type="password" path="confirmPassword"
												class="form-control" placeholder="Confirm your password"></form:input><br>
											<font color="red"><form:errors path="confirmPassword"></form:errors><br></font>
										</div>
									</spring:bind>
								</fieldset>
